...
public class RacingGame extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		container.getChildren().addAll(car1.getRec(), car2.getRec());
		// key pressed
...
class Car {
	...
	public Car(boolean primary) {
		...
		// 34.0, 13.0, 34.0, 6.0, 34.0, 7.0, 30.0, 3.0, 30.0, 3.0, 6.0, 3.0,
		// 6.0, 3.0, 2.0, 7.0,
		// 2.0, 8.0, 2.0, 14.0, 2.0, 14.0, 7.0, 16.0, 7.0, 16.0, 32.0, 15.0,
		// 32.0, 15.0, 34.0, 14.0

		up = new Polygon(40.0, 19.0, 40.0, 0.0, 39.0, 1.0, 36.0, 4.0, 35.0, 5.0, 35.0, 14.0, 36.0, 15.0);
		up.setStroke(Color.RED);
		up.setRotationAxis(Rotate.Z_AXIS);
		up.layoutXProperty().bind(locationX.add((w / 2)));
		up.layoutYProperty().bind(locationY.multiply(-1).add((RacingGame.height - w / 2)));
